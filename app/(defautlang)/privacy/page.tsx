      ...
      <div className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="lead">
              At Tier List Maker, we are committed to protecting your privacy.
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>Images:</strong> Images you upload to create tier lists
                are processed locally in your browser and are not stored on our
                servers unless you choose to save or share them.
              </li>
              <li>
                <strong>Contact Information:</strong> When you contact us, we
                may collect your email address and any information you provide
                in your message.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6">
              <li>
                ...
                how you use our website, including pages visited, time spent on
                the site, and referring websites.
              </li>
              <li>
                <strong>Device Information:</strong> We may collect information
                about the device you use to access our service, including
                browser type, operating system, and device identifiers.
              </li>
              <li>
                <strong>Cookies:</strong> We use cookies and similar
                technologies to enhance your experience and collect usage data.
            ...
            <p>
              ...
              those external sites or services. We encourage you to review the
            ...
            <p>
              ...
              advertising services such as Google AdSense. These services may
              use cookies or similar technologies to deliver ads based on your
              browsing history. Please refer to the privacy policies of these
              advertising partners for more information about their data
            ...
            <p>
              ...
              on our website. Cookies are small files stored on your device that
              help us:
            </p>
            <ul className="list-disc pl-6">
